...
def main():
    ...
    fileName = "C:\\Users\\chenjiaxing\\Desktop\\DICOM\\"
    ...
    v16.SetImageRange(0, 205)
    v16.SetDataByteOrderToLittleEndian()
    v16.SetFilePrefix(fileName)
    v16.SetFilePattern("%s%d.dcm")
    v16.SetDataSpacing(0.3, 0.3, 0.5)'''

    dicom = vtk.vtkDICOMImageReader()
    dicom.SetDirectoryName(fileName)
    dicom.Update()

    # An isosurface, or contour value of 500 is known to correspond to the
    # skin of the patient.
    skinExtractor = vtk.vtkMarchingCubes()
    skinExtractor.SetInputConnection(dicom.GetOutputPort())
