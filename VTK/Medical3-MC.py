...
sagittalColors.SetInputConnection(readerImageCast.GetOutputPort())
sagittalColors.SetLookupTable(bwLut)
sagittal = vtk.vtkImageActor()
sagittal.GetMapper().SetInputConnection(sagittalColors.GetOutputPort())
sagittal.SetDisplayExtent(32, 32, 0, 512, 0, 180)'''
...
axialColors.SetInputConnection(readerImageCast.GetOutputPort())
axialColors.SetLookupTable(hueLut)
axial = vtk.vtkImageActor()
axial.GetMapper().SetInputConnection(axialColors.GetOutputPort())
axial.SetDisplayExtent(0, 512, 0, 512, 46, 46)'''

# Create the third (coronal) plane of the three planes. We use the same
# approach as before except that the extent differs.
'''coronalColors = vtk.vtkImageMapToColors()
coronalColors.SetInputConnection(readerImageCast.GetOutputPort())
coronalColors.SetLookupTable(satLut)
coronal = vtk.vtkImageActor()
coronal.GetMapper().SetInputConnection(coronalColors.GetOutputPort())
coronal.SetDisplayExtent(0, 512, 32, 32, 0, 180)'''
